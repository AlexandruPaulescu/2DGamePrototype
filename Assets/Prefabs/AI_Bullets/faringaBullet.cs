...
public class faringaBullet : MonoBehaviour
{
   #region Variables

    private float speed = 18f;       // Speed of the bullet
    private int damage = 25;         // Damage of the bullet 
    ...
    /*
    *
    *   Edit Date : 30/10/2020 - 14PM
    *   Purpose : Adding the script
